...
> 更新时间：2026-08-30。本表记录当前实装；目标语义和已知风险以
...
- 四个腿驱动杆 effort limit 为 40 N m；轮毂按 Fudan **训练** URDF 标定为 Flat/Rough 5 N m、Jump
...
- pure-tensor mapping/air-time/reward tests：21 passed。
