...
def test_wyw_runner_uses_wide_action_clip_and_fudan_encoder_contract():
    ...
    assert '"extra_learning_rate": 1.0e-3' in source
    assert '"encoder_loss": "mse"' in source
    assert '"encoder_exclude_terminal": False' in source
