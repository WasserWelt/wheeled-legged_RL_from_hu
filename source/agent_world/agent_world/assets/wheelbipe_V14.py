...
Wheelbipe_V14_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{AssetPath}/usd_files/wheelbipe_V14_guide1/wheelbipe_V14_guide1.usd",
        # usd_path=f"{AssetPath}/usd_files/wheelbipe_V14/wheelbipe_V14.usd",
...
Wheelbipe_V14_No_Gimbal_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{AssetPath}/usd_files/wheelbipe_V14_no_gimbal/wheelbipe_V14_no_gimbal.usd",
        activate_contact_sensors=True,
        copy_from_source=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
...
Wheelbipe_V14_M3508_CFG = Wheelbipe_V14_CFG.copy()
Wheelbipe_V14_M3508_CFG.actuators = copy.deepcopy(Wheelbipe_V14_CFG.actuators)
Wheelbipe_V14_M3508_CFG.actuators["wheel"] = M3508ActuatorCfg(
    joint_names_expr=[".*_wheel_joint"],
    stiffness=0.0,
    damping=0.2,
